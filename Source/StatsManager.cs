...
//         PopupMessage("Session data exported to clipboard");
//     }
...
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.SuccessRate)) {
//             headerRow.Append($"Success Rate{(isSettingEnabled(MetricOutputChoice.Export, settings.TargetTime) ? $" (<={FormatTime(GetTargetTimeTicks())})" : "")},");
...
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.Average)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.Median)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.Minimum)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.Maximum)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.StandardDeviation)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.CoefficientOfVariation)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.Percentile)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.RunCount)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.CompletionRate)) {
...
//             }
//         }
//         if (isSettingEnabled(MetricOutputChoice.Export, settings.SoB)) {
...
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.SuccessRate)) {
//             string successRate = ((double)successCount / runCount).ToString("P2").Replace(" ", "");
//             sb.Append($"success{(isSettingEnabled(MetricOutputChoice.Overlay, settings.TargetTime) ? $" (<={FormatTime(GetTargetTimeTicks())})" : "")}: {successRate} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.RunCount)) {
//             sb.Append($"runs: {runCount.ToString()} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.Average)) {
//             average = segmentData.times.Average();
//             string averageString = FormatTime((long)Math.Round(average));
//             sb.Append($"avg: {averageString} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.Median)) {
//             string median = FormatTime(Percentile(segmentData.times, 50));
//             sb.Append($"med: {median} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.Minimum)) {
//             string best = FormatTime(segmentData.times.Min());
//             sb.Append($"best: {best} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.Maximum)) {
//             string worst = FormatTime(segmentData.times.Max());
//             sb.Append($"worst: {worst} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.StandardDeviation)) {
...
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.CoefficientOfVariation)) {
//             string cv = CoefficientOfVariation(segmentData.times, average, standardDeviation).ToString("P2").Replace(" ", "");
//             sb.Append($"cv: {cv} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.Percentile)) {
//             string percentile = FormatTime(Percentile(segmentData.times, ToInt(settings.PercentileValue)));
//             sb.Append($"{settings.PercentileValue.ToString()}: {percentile} | ");
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.CompletionRate)) {
...
//         }
//         if (isSettingEnabled(MetricOutputChoice.Overlay, settings.SoB)) {
//             long sob = 0;
//             for (int i = 0; i < roomData.Count; i++) {
//                 double min = roomData[i].times.Min();
...
//     private static bool isSettingEnabled(MetricOutputChoice output, MetricOutputChoice setting) {
//         return setting == MetricOutputChoice.Both || setting == output;
//     }
