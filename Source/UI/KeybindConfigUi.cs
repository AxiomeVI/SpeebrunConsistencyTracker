...
internal class KeybindConfigUi : TextMenu {
    ...
    private void Reload(int index = -1) {
        ...
        Add(new Setting(Dialog.Clean(DialogIds.KeyImportTargetTimeId), s.ButtonKeyImportTargetTime.Keys)
            .Pressed(() => StartRemap(Slot.ImportTargetTimeKeyboard)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyStatsExportId), s.ButtonKeyStatsExport.Keys)
            .Pressed(() => StartRemap(Slot.StatsExportKeyboard)));
        Add(new Setting(Dialog.Clean(DialogIds.ToggleGraphOverlayId), s.ButtonToggleGraphOverlay.Keys)
            .Pressed(() => StartRemap(Slot.ToggleGraphKeyboard)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyNextGraphId), s.ButtonNextGraph.Keys)
            .Pressed(() => StartRemap(Slot.NextGraphKeyboard)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyPreviousGraphId), s.ButtonPreviousGraph.Keys)
            .Pressed(() => StartRemap(Slot.PreviousGraphKeyboard)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyClearStatsId), s.ButtonKeyClearStats.Keys)
            .Pressed(() => StartRemap(Slot.ClearStatsKeyboard)));

        Add(new SubHeader(Dialog.Clean(DialogIds.BtnConfigTitle)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyImportTargetTimeId), s.ButtonKeyImportTargetTime.Buttons)
            .Pressed(() => StartRemap(Slot.ImportTargetTimeController)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyStatsExportId), s.ButtonKeyStatsExport.Buttons)
            .Pressed(() => StartRemap(Slot.StatsExportController)));
        Add(new Setting(Dialog.Clean(DialogIds.ToggleGraphOverlayId), s.ButtonToggleGraphOverlay.Buttons)
            .Pressed(() => StartRemap(Slot.ToggleGraphController)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyNextGraphId), s.ButtonNextGraph.Buttons)
            .Pressed(() => StartRemap(Slot.NextGraphController)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyPreviousGraphId), s.ButtonPreviousGraph.Buttons)
            .Pressed(() => StartRemap(Slot.PreviousGraphController)));
        Add(new Setting(Dialog.Clean(DialogIds.KeyClearStatsId), s.ButtonKeyClearStats.Buttons)
    ...
    private void ApplyRemap(Keys key) {
        ...
        List<Keys> list = _remappingSlot switch {
            Slot.ImportTargetTimeKeyboard => s.ButtonKeyImportTargetTime.Keys,
            Slot.StatsExportKeyboard      => s.ButtonKeyStatsExport.Keys,
            Slot.ToggleGraphKeyboard      => s.ButtonToggleGraphOverlay.Keys,
            Slot.NextGraphKeyboard        => s.ButtonNextGraph.Keys,
            Slot.PreviousGraphKeyboard    => s.ButtonPreviousGraph.Keys,
            _                             => s.ButtonKeyClearStats.Keys,
        };
        ApplyRemap(key, list);
    }
    ...
    private void ApplyRemap(Buttons button) {
        ...
        List<Buttons> list = _remappingSlot switch {
            Slot.ImportTargetTimeController => s.ButtonKeyImportTargetTime.Buttons,
            Slot.StatsExportController      => s.ButtonKeyStatsExport.Buttons,
            Slot.ToggleGraphController      => s.ButtonToggleGraphOverlay.Buttons,
            Slot.NextGraphController        => s.ButtonNextGraph.Buttons,
            Slot.PreviousGraphController    => s.ButtonPreviousGraph.Buttons,
            _                               => s.ButtonKeyClearStats.Buttons,
        };
